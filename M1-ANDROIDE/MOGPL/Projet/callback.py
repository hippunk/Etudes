...
# This example reads a model from a file, sets a callback to
# monitor the optimization progress, and outputs progress
# information to the screen and to a log file. If the input model
# is a MIP, the callback aborts the optimization after a 10% gap
# is reached or at least 10000 nodes have been explored and an
