...
\geometry{left=9cm,right=1cm,marginparwidth=6.8cm,marginparsep=1.2cm,top=1.25cm,bottom=1.25cm,footskip=2\baselineskip}
...
\name{Arthur Ramolet}
\tagline{Développeur outils Python, C\# }
...
\cvevent{Développeur outils Python C\#}{Hesion}{Juin 2020 -- Novembre 2021}{Achères}Développement d'outils pour la gestion des données internes ainsi que l'automatisation des processus de collecte et traitement des données.

\divider

\cvevent{IT Manager}{Kylotonn Racing}{Janvier 2020 -- Février 2020}{Paris}
Gestion, maintenance et amélioration du parc informatique.

\divider


\cvevent{Ingénieur de recherche - Développeur Unity C\#}{Université Champollion - Equipe SGRL}{Janvier 2018 -- Janvier 2019}{Albi}
Développement du jeu sérieux \underline{\href{https://www.univ-jfc.fr/actu/clone-un-serious-game-dedie-lorganisation-du-travail-en-milieu-hospitalier}{Clone}} pour la formation du personnel infirmier à l'organisation de l'emploi du temps.
